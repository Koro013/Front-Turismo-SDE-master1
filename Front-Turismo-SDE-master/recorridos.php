...
$sql = "SELECT r.id, r.nombre, r.descripcion,
               SUM(d.duracion) AS duracion_total,
               SUM(d.costo) AS costo_total
        FROM recorridos r
        JOIN recorridos_destinos rd ON r.id = rd.recorrido_id
        JOIN destinos d ON d.id = rd.destino_id
        GROUP BY r.id";
$recorridos = $pdo->query($sql)->fetchAll();
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<body class="bg-body bebas-neue-regular">
  <header>
    <nav class="navbar bg-dark border-body navbar-expand-lg" data-bs-theme="dark">
      <div class="container-fluid">
        <a class="navbar-brand text-light ms-3" href="#"><img id="navLogo" class="img-fluid" src="./img/santiago-logo.png" alt="Primera imagen" class="img-fluid"></a>
  ...
  <main class="container pt-5">
    <section class="form-check-inline me-0">
      ...
      <p class="gap-1">
        <a class="btn btn-primary mt-3 mb-2 ps-4 fs-4 container collapsed" data-bs-toggle="collapse" href="#listaCategoria" role="button" aria-expanded="false" aria-controls="listaCategoria" style="letter-spacing: 0.75vw">
          Filtros
        </a>
      </p>
      <form class="card card-body fs-4 collapse mb-4" id="listaCategoria" action="link" method="post" target="_self">
        <h1>Categorias</h1>
        <div class="form-check checkbox-personalizado form-check-inline">
          <input class="form-check-input" type="checkbox" name="categoria" value="1">
          <label class="form-check-label">Todas</label>
        </div>
        <div class="form-check checkbox-personalizado form-check-inline">
          <input class="form-check-input" type="checkbox" name="categoria" value="2">
          <label class="form-check-label">Deportivo</label>
        </div>
        <div class="form-check checkbox-personalizado form-check-inline">
          <input class="form-check-input" type="checkbox" name="categoria" value="3">
    ...
    <section class="row justify-content-evenly ms-1 me-1">
      ...
      <div class="card btn btn-light col-lg-3 p-0 me-lg-3 mb-lg-3 mb-3 col-md-12 tarjeta-recorrido">
        <img src="./img/pelota.svg" class="card-img-top p-5 tarjeta-imagen" alt="...">
        <div class="card-body">
          <p class="card-text fs-2"><?php echo htmlspecialchars($r['nombre']); ?></p>
          <div class="roboto-300">
            <p class="card-text text-start fs-5"><strong>Duración:</strong> <?php echo $r['duracion_total']; ?> min</p>
            <p class="card-text text-start fs-5"><strong>Costo:</strong> $<?php echo $r['costo_total']; ?></p>
            <p class="card-text text-start fs-5"><?php echo htmlspecialchars($r['descripcion']); ?></p>
          </div>
        </div>
      </div>
      <?php endforeach; ?>
  ...
  <footer class="container-fluid separacion-texto mt-4">
    <div class="row align-items-start nav-color pt-4">
      <div class="col-lg-5 col-md-12 card-footer text-light pt-sm-5 pb-sm-5 ps-3 pe-sm-5 pt-lg-5 pb-lg-5 ps-lg-5 pe-lg-5 text-light">
        ...
        <h4 class="mb-3"><strong>Correo:</strong> <a href="mailto:santiagoturismo2021@gmail.com" style="text-decoration: none; color: aliceblue;">santiagoturismo2021@gmail.com</a></h4>
      </div>
      <div class="flex-column text-center pt-3 pb-3 px-3 col-lg-7 col-md-12 card-footer text-light text-light">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3529.743254793991!2d-64.26247042469637!3d-27.78688407613697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x943b52115ea3ac05%3A0xb108231a9dab0636!2sSub%20Secretar%C3%ADa%20de%20Turismo%20de%20la%20Provincia%20de%20Santiago%20del%20Estero!5e0!3m2!1ses-419!2sar!4v1747236619964!5m2!1ses-419!2sar" class="mapa w-75" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
    </div>
